<x-app-layout>
    ...
    <!-- ========================================== -->
    {{-- Real data will be loaded from controller --}}
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <div class="flex items-center space-x-3 self-end sm:self-auto">
                ...
                <a href="{{ route('transaksi-bahan.create') }}" class="bg-[#007BFF] hover:bg-blue-700 text-white font-medium text-sm px-4 py-2.5 rounded-lg flex items-center transition duration-200 cursor-pointer shadow-sm">
                ...
                <!-- Input Pencarian -->
                <form method="GET" action="{{ route('transaksi-bahan') }}" class="relative">
                ...
                <tbody class="divide-y divide-gray-100 text-sm text-gray-600">
                    ...
                    <tr class="hover:bg-gray-50/50 transition">
                        ...
                        <td class="py-4 px-4">
                            ...
                            <a href="{{ route('transaksi-bahan.show', $item->id) }}" class="text-[#28A745] font-semibold text-sm">Lihat Detail</a>
                        </td>
