<x-guest-layout>
    ...
    Selamat Datang!
        ...
        <div class="w-full md:w-1/2 bg-white flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
            ...
            <div class="max-w-md w-full mx-auto">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <!-- Input Box Password -->
                    <div class="mb-8" x-data="{ showPassword: false }"> <label for="password" class="block text-sm lg:text-base font-semibold text-gray-700 mb-2">Password</label>
                         <div class="relative">
        ...
        <button type="button" @click="showPassword = !showPassword" 
                class="absolute inset-y-0 right-0 pr-4 flex items-center cursor-pointer text-gray-500 hover:text-[#1B432A] focus:outline-none">
